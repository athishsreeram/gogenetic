...
func main() {
	...
	if *archType == "es-cqrs" {
		...
		conf.Gogenetic.Esreadoutput = "es-read-output"
		conf.Gogenetic.Eventstorereadoutput = "eventstore-read-output"
		conf.Gogenetic.Cudoutput = "es-cud-output"
	...
	if *archType == "es-async-cmdhandler-cqrs" {
		...
		conf.Gogenetic.Escqrscud = dir + "/template/go/es-cqrs-cud/"
		conf.Gogenetic.Cudoutput = "es-cmdhandler-cud-output"
	...
	if *archType == "es-async-eventhandler-cqrs" {
		...
		conf.Gogenetic.Escqrscud = dir + "/template/go/es-cqrs-cud/"
		conf.Gogenetic.Cudoutput = "es-eventhandler-cud-output"
